...
function ticketPerformanceValue(option: TicketPerformanceOption) {
  return String(option?.schedule || option?.context_text || option?.label || "").trim();
}

function ticketPerformanceLabel(option: TicketPerformanceOption) {
  return String(option?.context_text || option?.label || option?.schedule || "")
