...
if (source.includes(marker)) {
  console.log("Alpha beta4 batch-install already applied");
  process.exit(0);
}
...
const temporary = wrapperPath + ".beta4-batch-v2.tmp";
await fs.writeFile(temporary, source, "utf8");
await fs.rename(temporary, wrapperPath);
console.log("Applied Alpha beta4 batch dependency install v2");
