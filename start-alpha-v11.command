...
echo "กำลังเตรียม Alpha v1.1.0-beta.5..."
...
echo "กำลังเปิด Alpha beta5 Host Tool Controller..."
...
if [[ "$READY" != true ]]; then
  echo "Alpha beta5 Host Tool Controller เปิดไม่สำเร็จ"
  echo "ดู log: $ALPHA_TOOL_ERROR_LOG_FILE"
  exit 1
fi

echo "Alpha v1.1.0-beta.5 พร้อม: adaptive thinking + deep agent context + beta4 task workflow"
